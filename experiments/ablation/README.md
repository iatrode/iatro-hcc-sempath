...
A1 and A3 retain the same classification tile images in the replay population while
masking their classification targets. This keeps replay composition matched. A5 and A6
